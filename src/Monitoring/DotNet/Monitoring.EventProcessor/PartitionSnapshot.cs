...
namespace Microsoft.Practices.IoTJourney.Monitoring.EventProcessor
{
    public class PartitionSnapshot
    {
        ...
        /// <summary>
        /// The last seen sequence number on the checkpoint for the consumer group.
        /// </summary>
        public long LastCheckpointSequenceNumber { get; set; }
        ...
        /// This is the delta between EndSequenceNumber and LastCheckpointSequenceNumber.
        /// </summary>
        public long UnprocessedEvents => EndSequenceNumber - LastCheckpointSequenceNumber;
